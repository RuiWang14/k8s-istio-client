...
func (c *FakeClusterRbacConfigs) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterRbacConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(clusterrbacconfigsResource, c.ns, name), &v1alpha1.ClusterRbacConfig{})
...
func (c *FakeClusterRbacConfigs) List(opts v1.ListOptions) (result *v1alpha1.ClusterRbacConfigList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(clusterrbacconfigsResource, clusterrbacconfigsKind, c.ns, opts), &v1alpha1.ClusterRbacConfigList{})
...
func (c *FakeClusterRbacConfigs) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(clusterrbacconfigsResource, c.ns, opts))
...
func (c *FakeClusterRbacConfigs) Create(clusterRbacConfig *v1alpha1.ClusterRbacConfig) (result *v1alpha1.ClusterRbacConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(clusterrbacconfigsResource, c.ns, clusterRbacConfig), &v1alpha1.ClusterRbacConfig{})
...
func (c *FakeClusterRbacConfigs) Update(clusterRbacConfig *v1alpha1.ClusterRbacConfig) (result *v1alpha1.ClusterRbacConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(clusterrbacconfigsResource, c.ns, clusterRbacConfig), &v1alpha1.ClusterRbacConfig{})
...
func (c *FakeClusterRbacConfigs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(clusterrbacconfigsResource, c.ns, name), &v1alpha1.ClusterRbacConfig{})
...
func (c *FakeClusterRbacConfigs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(clusterrbacconfigsResource, c.ns, listOptions)
...
func (c *FakeClusterRbacConfigs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterRbacConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clusterrbacconfigsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ClusterRbacConfig{})
